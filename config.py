...
data_paths = {
    'chexpert':
    '/media/tianyu.han/mri-scratch/DeepLearning/CheXpert_Dataset/images_256/chexpert_lmdb/256',
    'chexpert_train':
    '../CheXpert_Dataset/images_256/images',
    'mimic':
    '/media/tianyu.han/mri-scratch/DeepLearning/Stanford_MIT_CHEST/MIMIC-CXR-v2.0/lmdb/256',
    'padchest':
...
class TrainConfig(BaseConfig):
    ...
    def make_dataset(self, path=None, **kwargs):
        if self.data_name == 'ffhqlmdb256':
            ...
            return chexpert_lmdb(path=path or self.data_path,
                            image_size=self.img_size,
                            **kwargs) 
        elif self.data_name == 'mimic':
            return mimic_lmdb(path=path or self.data_path,
                            image_size=self.img_size,
                            **kwargs) 
        elif self.data_name == 'padchest':
